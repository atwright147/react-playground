...
import { type ComponentPropsWithRef, type FC, forwardRef, type ReactNode, type Ref } from 'react';
    ...
    return (
      <div className={styles.field}>
        ...
        <div className={styles.group}>
          ...
          <input id={id} className={classnames(styles.input, className)} aria-describedby={describedby} ref={ref} {...props} />
